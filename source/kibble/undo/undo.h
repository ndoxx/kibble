...
namespace kb
{
    ...
    public:
         ...
         * from the outside. Pushing a command immediately executes its redo() function. Any command that can be redone before
         * cmd is pushed will be destroyed, so the head will always match the command count. If the clean state was located
         * after head, it will be reset.
         * Before the command is pushed however, this function will attempt to merge it with the previous one on the stack
         * (the next command to undo). If the merge is successful, cmd will be destroyed. And if the merge produces an obsolete
         * command, it will be destroyed as well. In any other case, cmd is simply pushed to the stack.
         * If the undo limit is not set to zero and the command count exceeds it, the furthest command in the stack will be
         * destroyed, so as to keep the command count constant.
         * 
    ...
    public:
        ...
        /**
         * @brief Set the stack corresponding to this name as the active stack. If no stack exists at that name, nothing will
         * happen.
         * 
        ...
        /**
         * @brief Set a functor to be called whenever the active stack's clean state changes, or the active stack changes itself.
         * 
         * @param func 
         */
        ...
        /**
         * @brief Set a functor to be called whenever the active stack's can_undo() property changes, or the active stack changes itself.
         * 
         * @param func 
         */
        ...
        /**
         * @brief Set a functor to be called whenever the active stack's can_redo() property changes, or the active stack changes itself.
         * 
         * @param func 
         */
